...
namespace FinalNet3.Services.Administracion
{
    public class BodegaService : IBodegaService
    {
        ...
        public IList<String> SaveInfo(BodegaDTO obj)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.CommandText = "guardarBodega";
                    ...
                    dp = comm.CreateParameter();
                    dp.ParameterName = "@Direccion";
                    dp.Value = obj.direccion;
                    comm.Parameters.Add(dp);
        ...
        public IList<String> DeleteInfo(int id)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "eliminarBodega";
