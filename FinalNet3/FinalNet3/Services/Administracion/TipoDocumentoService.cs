...
namespace FinalNet3.Services.Administracion
{
    public class TipoDocumentoService : ITipoDocumentoService
    {
        ...
        public IList<string> SaveInfo(DTO.Administracion.TipoDocumentoDTO objDTO)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.CommandText = "guardarTipoDocumento";
        ...
        public IList<string> ListInfo()
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "listarTipoDocumento";
        ...
        public IList<string> SearchInfo(string nombre)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "buscarTipoDocumento";
        ...
        public IList<string> DeleteInfo(int id)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "eliminarTipoDocumento";
        ...
        public IList<String> LoadTipoDocumento()
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "cargarTipoDocumento";
