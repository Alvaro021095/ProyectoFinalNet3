...
{
    public class TipoAfiliacionService : ITipoAfiliacionService
    {

         private SqlConnection Conn { get; set; }


        public TipoAfiliacionService()
        {

        }

        public IList<String> SaveInfo(TipoAfiliacionDTO obj)
        {
        ...
        public IList<String> SearchInfo(String nombre)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "buscarTipoAfiliacion";
        ...
        public IList<String> DeleteInfo(int id)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "eliminarTipoAfiliacion";
        ...
        public IList<String> ListInfo()
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "listarTipoAfiliacion";
        ...
        public IList<String> LoadTipoAfiliacion()
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "cargarTipoPaciente";
