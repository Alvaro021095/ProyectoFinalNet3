...
{
    public class EstadoPrescripcionService : IEstadoPrescripcionService
    {

         private SqlConnection Conn { get; set; }


        public EstadoPrescripcionService()
        {

        }

        public IList<String> SaveInfo(EstadoPrescripcionDTO obj)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.CommandText = "guardarEstadoPrescripcion";
        ...
        public IList<String> SearchInfo(String nombre)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "buscarEstadoPrescripcion";
        ...
        public IList<String> DeleteInfo(int id)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "eliminarEstadoPrescripcion";
        ...
        public IList<String> ListInfo()
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "listarEstadoPrescripcion";
