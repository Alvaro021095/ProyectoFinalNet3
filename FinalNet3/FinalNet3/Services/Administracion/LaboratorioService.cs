...
namespace FinalNet3.Services.Administracion
{
    public class LaboratorioService : ILaboratorioService
    {
        ...
        public IList<String> SaveInfo(LaboratorioDTO obj)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.CommandText = "guardarLaboratorio";
        ...
        public IList<String> SearchInfo(String nombre)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "buscarLaboratorio";
        ...
        public IList<String> DeleteInfo(int id)
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "eliminarLaboratorio";
        ...
        public IList<String> ListInfo()
        {
            ...
            try
            {
                using (Conn = new Connection().Conexion)
                {
                    ...
                    comm.Connection = Conn;
                    comm.CommandType = CommandType.StoredProcedure;
                    comm.CommandText = "listarLaboratorio";
