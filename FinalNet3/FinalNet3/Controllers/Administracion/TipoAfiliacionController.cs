...
{
    public class TipoAfiliacionController : BaseController
    {

        private static readonly ITipoAfiliacionService ContractService = new TipoAfiliacionService();
        ...
        public ActionResult SaveInfo(int id, String nombre, String descripcion)
        {
            ...
            TipoAfiliacionDTO objDTO = new TipoAfiliacionDTO(id, nombre, descripcion);
        ...
        {
            /*Se recibe en una lista generica el resultado del login definida en el service y obligada por el contract*/
            IEnumerable<String> info = ContractService.LoadTipoAfiliacion();
            /*Se para la lista de la respuesta a JSON*/
            return Json(new { d = info });
        }
