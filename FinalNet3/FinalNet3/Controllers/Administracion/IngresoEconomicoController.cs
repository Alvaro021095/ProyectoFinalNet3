...
{
    public class IngresoEconomicoController : BaseController
    {

        private static readonly IIngresoEconomicoService ContractService = new IngresoEconomicoService();

        public ActionResult SaveInfo(int id, String nombre, String categoria, double valor_cat_cit,
            double valor_cat_medica)
        {
            /*Se define el DTO (Clase que solo define datos, no funciones que lo diferencia del modelo)*/
            IngresoEconomicoDTO objDTO = new IngresoEconomicoDTO(id, nombre, categoria, valor_cat_cit, valor_cat_medica);
