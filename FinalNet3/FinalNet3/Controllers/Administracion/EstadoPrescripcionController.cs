...
{
    public class EstadoPrescripcionController : BaseController
    {

        private static readonly IEstadoPrescripcionService ContractService = new EstadoPrescripcionService();
        ...
        public ActionResult SaveInfo(int id, String nombre, String descripcion)
        {
            ...
            EstadoPrescripcionDTO objDTO = new EstadoPrescripcionDTO(id, nombre, descripcion);
