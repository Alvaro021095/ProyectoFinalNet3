...
function guardar() {
    ...
    if (horario != "" && descripcion != "") {
        $.ajax({
            type: 'POST',
            url: "/MedicoHorario/SaveInfo",
            data: { id: id, horario: horario, descripcion: descripcion },
...
function buscar() {
    ...
    if (horario != "") {
        ...
        $.ajax({
            type: 'POST',
            url: "/MedicoHorario/SearchInfo",
            data: { horario: horario },
            success: function (data) {
                if (data.d.length > 0) {
                    $("#txtId").val(data.d[0]);
                    $("#txtHorario").val(data.d[1]);
